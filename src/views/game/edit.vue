<template>
  <div style="margin: 50px;">
    <h3 style="color: #606266;font-weight:normal;line-height: 30px;margin-bottom:50px;">游戏编辑</h3>
    <el-row>
      <el-col :span="12" :offset="6">
        <el-form :model="value" :rules="rules" ref="gameForm" label-width="120px" style="width: 400px;" size="small">
          ...
          <el-form-item label="支付订单回调：" prop="notify_url" class="pos">
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        rules: {
          ...
          notify_url: [{required: true, message: '',validator: validNotifyUrl,trigger: 'blur'}],
        },
        value:{
          name: '王者农药',
    ...
    created() {
      ...
      this.value.notify_url = rowInfo.notify_url;
    ...
    methods: {
     // 提交保存
      handleNext(formName){
        ...
        //   }
        // });
        this.testBackUrl(formName, true);
      },
      // 添加游戏
      handleEditGame(params) {
